...
//            icdcode.add("R63.4");
            ...
            Patient pp= new Patient(3,"R13.1", "Active", LocalDate.of(2022,06,30),LocalDate.of(1960,06,22));
            Patient pp1= new Patient(3,"K21.0", "Inactive", LocalDate.of(2022,06,30),LocalDate.of(1960,06,22));
